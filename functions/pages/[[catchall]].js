 ...
 * Route: /pages/* (all direct requests to the /pages/ directory)
 *
 * Intercepts requests like /pages/Contact or /pages/GCC/Overview
 * and permanently redirects them to the canonical clean URL.
 *
 * This does NOT affect _redirects 200 rewrites, which internally
 * serve these files without creating a new HTTP request.
 */
...
export async function onRequest(context) {
  ...
  // Strip .html extension if present (Cloudflare Pretty URLs may or may not strip it)
  ...
  // No mapping found — return 404 for any unknown /pages/... path
